...
1. [Computing and Parallelism Foundations](01-computing-and-parallelism-foundations/) — includes a visual lab
2. [The GPU Execution Model](02-gpu-execution-model/)
3. [Compute Units and Tensor Cores](03-compute-units-and-tensor-cores/)
4. [GPU Memory Hierarchy](04-gpu-memory-hierarchy/)
5. [Why GPU Workloads Become Slow](05-performance-limiters/)
6. [CUDA Software Stack and GPU Observability](06-cuda-software-stack-and-observability/)
